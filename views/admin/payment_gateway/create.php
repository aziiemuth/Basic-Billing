...
<div class="mb-4">
    ...
    <h4 class="fw-bold text-white mb-0 mt-2">Tambah Payment Gateway</h4>
</div>

<div class="card glass-card border-0 shadow-sm">
    <div class="card-body p-4">
        <form action="<?php echo URLROOT; ?>/AdminPaymentGatewayController/store" method="POST">
            <?php echo SecurityHelper::csrfField(); ?>
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label text-secondary small">Nama Gateway</label>
                    <input type="text" name="name" class="form-control bg-dark text-white border-secondary border-opacity-25" value="Midtrans" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="server_key" class="form-control bg-dark text-white border-secondary border-opacity-25">
                </div>
                <div class="col-md-6">
                    <label class="form-label text-secondary small">Client Key</label>
                    <input type="text" name="client_key" class="form-control bg-dark text-white border-secondary border-opacity-25">
                </div>
                <div class="col-12">
