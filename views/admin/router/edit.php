    ...
    <?php echo SecurityHelper::csrfField(); ?>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="pppoe_interface" class="form-control bg-dark border-secondary border-opacity-25 text-white" value="<?php echo htmlspecialchars($data['router']->pppoe_interface); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-secondary small mb-1">Status</label>
                            <div class="form-check form-switch mt-2">
                                <input class="form-check-input" type="checkbox" role="switch" id="is_active" name="is_active" value="1" <?php echo $data['router']->is_active ? 'checked' : ''; ?>>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="description" rows="3" class="form-control bg-dark border-secondary border-opacity-25 text-white"><?php echo htmlspecialchars($data['router']->description); ?></textarea>
                        </div>
                    </div>
