...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
    ...
    <a href="<?php echo URLROOT; ?>/AdminUserController/create" class="btn btn-primary btn-sm px-3 fw-medium d-flex align-items-center gap-2">
        <i class="bi bi-person-plus"></i> <span>Tambah User</span>
    </a>
</div>
                    ...
                    <?php foreach ($data['users'] as $user): ?>
                        <tr>
                            ...
                            <td class="pe-4 text-end">
                                ...
                                <a href="<?php echo URLROOT; ?>/AdminUserController/edit/<?php echo $user->id; ?>" class="btn btn-sm btn-outline-warning border-opacity-25" title="Edit"><i class="bi bi-pencil"></i></a>
