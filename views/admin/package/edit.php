...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <h4 class="fw-bold text-white mb-0">Edit Paket: <?php echo htmlspecialchars($data['package']->name); ?></h4>
    </div>
</div>
    ...
    <div class="row g-4">
                ...
                <div class="card-body p-4">
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" class="form-control bg-dark border-secondary border-opacity-25 text-white" value="<?php echo htmlspecialchars($data['package']->name); ?>" required>
                        </div>
                        
                        <div class="col-md-6">
                            <label class="form-label text-secondary small fw-medium">Kecepatan Download (Mbps)</label>
                            <div class="input-group">
                                <input type="number" min="1" name="speed_download" class="form-control bg-dark border-secondary border-opacity-25 text-white border-end-0" value="<?php echo $data['package']->speed_download; ?>" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" min="1" name="speed_upload" class="form-control bg-dark border-secondary border-opacity-25 text-white border-end-0" value="<?php echo $data['package']->speed_upload; ?>" required>
                                <span class="input-group-text bg-dark border-secondary border-opacity-25 text-secondary border-start-0">Mbps</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" min="0" step="1000" name="price" class="form-control bg-dark border-secondary border-opacity-25 text-white border-start-0" value="<?php echo $data['package']->price; ?>" required>
                            </div>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label text-secondary small fw-medium">Nama Profile MikroTik</label>
                            <input type="text" name="mikrotik_profile" class="form-control bg-dark border-secondary border-opacity-25 text-white font-monospace" value="<?php echo htmlspecialchars($data['package']->mikrotik_profile); ?>" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" rows="3" class="form-control bg-dark border-secondary border-opacity-25 text-white"><?php echo htmlspecialchars($data['package']->description); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-xl-4">
            <div class="card glass-card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    <div class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" role="switch" id="auto_isolate" name="auto_isolate" value="1" <?php echo $data['package']->auto_isolate ? 'checked' : ''; ?>>
                    ...
                    <div class="form-check form-switch mb-4">
                        <input class="form-check-input" type="checkbox" role="switch" id="is_active" name="is_active" value="1" <?php echo $data['package']->is_active ? 'checked' : ''; ?>>
            ...
            <button type="submit" class="btn btn-primary w-100 py-3 fw-bold shadow">
                <i class="bi bi-save me-2"></i> Update Paket
            </button>
        </div>
    </div>
</form>
